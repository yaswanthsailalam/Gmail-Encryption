...
if(!enc.equals(""))
{
	try{
         ...
         String dValue=new String(original);
...
%>
<div id="wrap">
<div id="header">SECURITY MAIL COMMUNICATOR</div>
<div id="header2"><table><tr><td align="left"><a href="loginsuccess.jsp"><font color="#3322dd"><b>Send Mail</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="center"><a href="decrypt.jsp"><font color="#3322dd"><b>Decrypt Mail</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right"><a href="home.html"><font color="#3322dd"><b>Sign Out</b></font></a></td></tr></table></div>
<center>
<br><br>
<div class="sideBox">
...
<td><textarea rows="7" cols="70" name="enc"><%=enc%></textarea></td></tr>
<tr><td><b>PrivateKey:</b></td><td><input type="text" name="encdeckey" value="<%=key2%>"></td></tr>
<tr><td><b>Message:</b></td><td><textarea rows="7" cols="70" name="msg" value="<%=msg3%>"><%=msg3%></textarea></td></tr>
